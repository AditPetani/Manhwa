...
simi = await fetchJson(`https://api.simsimi.net/v2/?lc=id&cf=false&text=${prefix+command}`)           
...
let id = m.sender
		 ...
		 await haruka.sendMessage(nomorNya + '@s.whatsapp.net',  {image: tod, caption:yoi }, {quoted:m})
