...
try {
    ...
    haruka.sendMessage(anu.id, {image: welcome, caption: full_pesan, mentions: [num]})
                      // haruka.sendMessage(anu.id, { caption: `${full_pesan}`, image: { url: pp_user }, mentions: [num] })
                   } else {
haruka.sendMessage(anu.id, {image: welcome, caption: `Welcome @${num.split("@")[0]} in the group ${groupName}`, mentions: [num]})
...
haruka.sendMessage(anu.id, {image: leave, caption: full_pesan, mentions: [num]})

                       } else {
haruka.sendMessage(anu.id, {image: leave, caption: `Sayonara @${num.split("@")[0]}`, mentions: [num]})
                        } 
